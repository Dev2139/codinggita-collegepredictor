  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start items-center w-full mt-8 pb-10 bg-white">
        <div className="text-center flex flex-col items-center w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mt-8 p-8 pb-10 bg-[#facc15] shadow-inner drop-shadow-md rounded-md">
          <Script
